...
public class AdapterShebei extends BaseAdapter {
    Context mcontext;
   List<shebeientity> shebeientities;

    public AdapterShebei(Context mcontext, List<shebeientity> shebeientities) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ViewHolder holder = null;
        ...
        holder.textview1.setText("设备名称："+shebeientities.get(position).shebeimingcheng);
        holder.textview2.setText("设备型号："+shebeientities.get(position).shebeileixing);
